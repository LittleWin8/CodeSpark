...
/** 应用部署域名（部署后对外访问的地址，nginx 服务地址；留空表示与当前站点同域） */
const DEPLOY_BASE_URL = import.meta.env.VITE_APP_DEPLOY_BASE_URL || ''
 ...
 * @returns 完整部署 URL，如 https://codespark.littlewin.top/{deployKey}/
 */
